    ...
    <div class="container_12 pop-content">
        ...
        <div class="grid_6 prefix_1">
            <div class="form login-form">
                <form action="#">
                    <h3 class="rs title-form">Regístrate</h3>
                    <div class="box-white">
                        <h4 class="rs title-box">¿Eres nuevo en Real Fund?</h4>
                        <p class="rs">Se necesita una cuenta para seguir en Real Fund</p>
                        <div class="form-action">
                            ...
                            <p class="rs pb10">Al darte de alta, estás de acuerdo con <a href="#" class="fc-orange">nuestros términos de uso</a> y <a href="#" class="fc-orange">política de privacidad</a>.</p>
                            <p class="rs ta-c">
                                <button class="btn btn-red btn-submit" type="submit">Regístrate</button>
                            </p>
                        </div>
                    </div>
                </form>
            ...
            <div class="form login-form">
                <form action="#">
                    ...
                    <div class="box-white">
                        ...
                        <p class="rs">Por favor, log in para continuar.</p>
                        <div class="form-action">
                            ...
                            <label for="chk_remember" class="rs pb20 clearfix">
                                ...
                                <span class="lbl-remember">Recuérdame</span>
                            </label>
                            <p class="rs ta-c pb10">
                                <button class="btn btn-red btn-submit" type="submit">Login</button>
                            </p>
                            <p class="rs ta-c">
                                <a href="#" class="fc-orange">He olvidado mi contraseña</a>
                            </p>
                        </div>
                    </div>
                </form>
